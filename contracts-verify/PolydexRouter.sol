...
// File: contracts\interfaces\IPolydexRouter01.sol

pragma solidity >=0.6.2;

interface IPolydexRouter01 {
...
// File: contracts\interfaces\IPolydexRouter02.sol

pragma solidity >=0.6.2;

interface IPolydexRouter02 is IPolydexRouter01 {
...
// File: contracts\interfaces\IPolydexFactory.sol
...
// File: contracts\interfaces\IPolydexPair.sol
...
// File: contracts\libraries\PolydexLibrary.sol
...
library PolydexLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'f08a4213eb01cdf62b2ef9d7bd2e4e7912303fa3a51e5eb1e5fe4834a5e56349' // init code hash
            ))));
    }
...
// File: contracts\PolydexRouter.sol
...
contract PolydexRouter is IPolydexRouter02 {
    using SafeMath for uint;
    ...
    function removeLiquidity(
        ...
        address pair = PolydexLibrary.pairFor(factory, tokenA, tokenB);
        IPolydexPair(pair).transferFrom(msg.sender, pair, liquidity); // send liquidity to pair
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(
            path[0], msg.sender, PolydexLibrary.pairFor(factory, path[0], path[1]), amounts[0]
        );
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        TransferHelper.safeTransferFrom(
            path[0], msg.sender, PolydexLibrary.pairFor(factory, path[0], path[1]), amountIn
        );
